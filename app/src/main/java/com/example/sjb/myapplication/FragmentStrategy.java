...
public class FragmentStrategy extends Fragment {

    private TextView textView;
    final static String TAG = "FragmentStrategy";
    ...
    private WebViewClient webViewClient = new WebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (checkNet())
                ActivityManage.getInstance().changeActivity(url, ActivityFive.class, 5);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (checkNet())
            webView.loadUrl(Constants.DKGL);
        else showDialog(1, Constants.DKGL);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (checkNet())
                    webView.reload();
                else showDialog(2, Constants.DKGL);
            }
        });
        return view;
    }
