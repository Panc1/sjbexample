...
public class ActivityTwo extends ActivityBase implements View.OnClickListener {

    static final private String TAG = ">>>>ActivityTwo";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout goBack = (LinearLayout) findViewById(R.id.goBack);
