...
public class FragmentHome extends Fragment {
    static final private String TAG = ">>>> FragmentHome";
    ...
    private WebViewClient webViewClient = new WebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (checkNet()) {
                if (url.contains(Constants.tag_1)) {
                    ActivityManage.getInstance().changeActivity(url, ActivityTwo.class, 2);
                } else {
                    ActivityManage.getInstance().changeActivity(url, ActivityThree.class, 3);
                }
            } else {
                Log.e(TAG, "app->>>shouldOverrideUrlLoading  Net is disconnect");
                showDialog(3, url);
            }
            return true;
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        else showDialog(1, Constants.Home_Site);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (checkNet())
                    webView.reload();
                else showDialog(2, Constants.Home_Site);
            }
        });
        return view;
    }
    ...
    public void Refresh() {
        if (checkNet()) {
            ...
            showDialog(2, Constants.Home_Site);
        }
    }
