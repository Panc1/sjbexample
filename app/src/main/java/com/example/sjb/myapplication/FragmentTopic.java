...
public class FragmentTopic extends Fragment {
    ...
    final static String TAG = "FragmentTopic";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (checkNet()) webView.loadUrl(Constants.JRRM);
        else showDialog(1, Constants.JRRM);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (checkNet()) webView.reload();
                else showDialog(2, Constants.JRRM);
            }
        });
        return view;
    }
        ...
        if (checkNet()) {
            ...
            if (webView != null) {
                if (position != 1)
                    ...
                    webView.loadUrl(Constants.JRRM);
            }
        } else showDialog(2, Constants.JRRM);
    }
